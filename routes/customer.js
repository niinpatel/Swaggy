...
Router.route("/register").get((req,res,next)=>{
    ...
    req.checkBody("Customer_Mobile", "Invalid Number").matches(/^(\+\d{1,3}[- ]?)?\d{10}$/);
    req.checkBody("Customer_Password","Password Not Matched").equals(req.body.Customer_Password2);
